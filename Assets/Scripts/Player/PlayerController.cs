...
public class PlayerController : MonoBehaviour {
    ...
    public void RotateBodyToFaceInput() {
        ...
        // Vector3.up vai ser um valor fixo para cima. Como (0, 1, 0)
        // lookRotation sendo para dizer qual rotação olhar
        Quaternion q2 = Quaternion.Euler(0, camera.transform.eulerAngles.y, 0);
        // pega o transform da camera para usar no código
        // Euler rotação baseada em angulos
        Quaternion toRotation = q1 * q2;
        Quaternion newRotation = Quaternion.LerpUnclamped(transform.rotation, toRotation, 0.15f);
        // LerpUnclamped é para interpolar no meio entre dois valores, o 0.15 sendo 15% do valor entre os pontos. A movimentação
